...
public class StockMarket implements Serializable {
	...
	public void buyStock(Investor i, Stock s, int quantity) {//this method sell the stock in investor portfolio
	...
	public void sellStock(Investor i, Stock s, int quantity) {//this method adds the stock in investor portfolio
